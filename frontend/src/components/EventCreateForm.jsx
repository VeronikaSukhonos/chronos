...
import Events from '../api/calendarsApi.js';
import {
  addToCalendar, updateInCalendar, selectEventCreateForm, setForm, closeForm
} from '../store/calendarSlice.js';
import {
  Modal, TextField, TextAreaField, ColorField, UserSearchForm, Checkbox, MainButton
} from '../components';
